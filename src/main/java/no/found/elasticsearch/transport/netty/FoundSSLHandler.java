...
import no.found.elasticsearch.transport.netty.ssl.ImmediateExecutor;
import no.found.elasticsearch.transport.netty.ssl.NotSslRecordException;
import no.found.elasticsearch.transport.netty.ssl.SslBufferPool;
...
import static org.elasticsearch.common.netty.channel.Channels.*;
 ...
 * situations were {@link FoundSSLHandler} is used in 'client mode' you want to issue a handshake once
 * the connection was established. if {@link #setIssueHandshake(boolean)} is set to {@code true}
 * you don't need to worry about this as the {@link FoundSSLHandler} will take care of it.
 * <p>
 *
 * <h3>Renegotiation</h3>
 * <p>
 ...
 * exception is when you close the {@link Channel} - {@link FoundSSLHandler}
 ...
 * {@link FoundSSLHandler} with a new {@link SSLEngine} as explained in the
 * following section.
 *
 * <h3>Restarting the session</h3>
 * <p>
 * To restart the SSL session, you must remove the existing closed
 * {@link FoundSSLHandler} from the {@link ChannelPipeline}, insert a new
 * {@link FoundSSLHandler} with a new {@link SSLEngine} into the pipeline,
 ...
 * <ol>
 * <li>create a new {@link FoundSSLHandler} instance with {@code startTls} flag set
 *     to {@code true},</li>
 * <li>insert the {@link FoundSSLHandler} to the {@link ChannelPipeline}, and</li>
 * <li>write a StartTLS response.</li>
 * </ol>
 * Please note that you must insert {@link FoundSSLHandler} <em>before</em> sending
 * the StartTLS response.  Otherwise the client can send begin SSL handshake
 * before {@link FoundSSLHandler} is inserted to the {@link ChannelPipeline}, causing
 * data corruption.
 * <p>
 ...
 *     to {@code false},</li>
 * <li>insert the {@link FoundSSLHandler} to the {@link ChannelPipeline}, and</li>
 * <li>Initiate SSL handshake by calling {@link FoundSSLHandler#handshake()}.</li>
 * </ol>
 *
 * <h3>Known issues</h3>
 * <p>
 ...
 */
public class FoundSSLHandler extends FrameDecoder
    ...
    public void exceptionCaught(ChannelHandlerContext ctx, ExceptionEvent e)
        ...
        if(cause instanceof SSLException && (cause.getMessage().contains("closing") || cause.getMessage().contains("closed"))) return;
